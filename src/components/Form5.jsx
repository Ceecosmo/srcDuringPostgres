...
// <input type="text" name='DataAna'  value='Course: Data Analysis' className='form-control'/> 
...
// <input type="" style={{fontSize: 'bold'}} name='emailmm' value='N80,000'  className='form-control'/> 
