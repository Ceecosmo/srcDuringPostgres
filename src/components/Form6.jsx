...
// <input type="text" name='ComLiteracy'  value='Course: Computer Literacy' className='form-control'/> 
...
// <input type="" style={{fontSize: 'bold'}} name='emailmm' value='N37,500'  className='form-control'/> 
...
{/* <a href="https://primeafricatechnologies.onrender.com/" className="btn btn-danger mt-2" >Continue &#8594;</a>
</form> */}
